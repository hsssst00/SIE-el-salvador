...
- [x] **C4** `src/evaluacion/verificar_motor_sintetico.R` — bloques V1 a V11 implementados (paso 4); V11 hace SKIP mientras el paquete `MCS` (Suggests) no esté instalado.
